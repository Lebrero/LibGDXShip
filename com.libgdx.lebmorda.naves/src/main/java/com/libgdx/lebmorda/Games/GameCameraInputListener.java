...
public class GameCameraInputListener extends ScreenAdapter {
	...
	public GameCameraInputListener(BasicGame game) {
		this.game = game;
	...
	private void inputListener() {
		...
		if (vController.isMoverCamaraArriba()) {
			...
			nave.setColorActor(Color.GREEN);
