...
public class GamePatrones_1 extends ScreenAdapter {
	...
	public GamePatrones_1(BasicGame game) {
		this.game = game;

		gamecam = new OrthographicCamera();
		gameport = new FitViewport(BasicGame.GAME_WIDTH_X, BasicGame.GAME_HEIGHT_Y, gamecam);
	...
	public void show() {
		...
		square.setWidth(650f);
		square.setHeight(650f);
		square.centerOrigin().centerPositionScreen();
	...
	private void configActors() {
		nave.centerOrigin().centerPositionScreen();
	}
