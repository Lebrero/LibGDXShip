...
import com.lingdx.lebmorda.patrones.GamePatrones_1;
import com.lingdx.lebmorda.patrones.GamePatrones_2;
import com.lingdx.lebmorda.patrones.GamePatrones_3;
	...
	public void show() {
		...
		playButton.addListener(new InputListener() {
			...
			public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
				game.setScreen(new GamePatrones_3(game));
			}
